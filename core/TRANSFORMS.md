...
Our forward convention is **-Z**, right is +X, up is +Y. Unity's forward is +Z. Movement takes a
...
| Face a target | TransformLookAt / Transform2DLookAt | Object orientation, distinct from a camera view matrix. |
